...
public class DownloadedAdapter extends RecyclerView.Adapter<DownloadedAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_downloaded_manager, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @Bind(R.id.icon_downoladed) ImageView icon;
        @Bind(R.id.name_downloaded) TextView name;
...
//            ApkUtils.install(context,new File(progress.filePath.toString()));
            updateData(type);
        }
